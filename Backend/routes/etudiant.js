...
router.post('/'/*Inscription*/, etudiantCtrl.signup);                       // Création d'un compte étudiant
router.post('/login', etudiantCtrl.login);                                  // Connexion d'un étudiant
router.put('/:id',auth.verifyToken, etudiantCtrl.update)                    // Modification d'un compte étudiant identifier avec son "id"
router.put('/:id/UpdateMdp',auth.verifyToken,etudiantCtrl.changeMdp)        // Modification du mots de passe du compte identifier avec son "id"
