...
router.get('/etudiants',auth.verifyToken, groupeCtrl.selectAllEtudiant)                      //récupère tous les étudians (id, nom, premnom) de la promo (Autocompletion quand un étudiant ajoutera d'autre étudiant à son groupe)
